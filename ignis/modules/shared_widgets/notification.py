...
class ScreenshotLayout(widgets.Box):
                ...
                widgets.Box(
                    ...
                    child=[
                        widgets.Button(
                            ...
                            on_click=lambda x: self._open_screenshot(notification.icon),
                        ),
                        widgets.Button(
    ...
    def _open_screenshot(self, file_path: str) -> None:
        """Open screenshot using async subprocess."""
        asyncio.create_task(self._exec_command(f"xdg-open {file_path}"))
